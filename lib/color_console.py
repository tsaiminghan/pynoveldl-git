...
from https://www.burgaud.com/bring-colors-to-the-windows-console-with-python
"""
...
class MAGENTA(_base):
  def __init__(self):
    super().__init__(FOREGROUND_MAGENTA | FOREGROUND_INTENSITY)
